...
class MyCompte extends React.Component {
  ...
  handleChangePic = event => {
    ...
    this.setState({
      file:this.state.file.concat(event.target.files[0])
    });
  };
  //-------------------SUBMITE HANDLER-------------------------------------
  mySubmitHandler = event => {
    ...
    if (
      ...
      console.log(this.state.selectedOptionFirst.value);
      console.log(this.state.selectedOptionSecond.value);
      ...
      this.state.file.forEach(element => formData.append('images',element));
      formData.append("title",this.state.title);
      formData.append("categoryName",this.state.selectedOptionFirst.value) ;
      formData.append("sousCategory", this.state.selectedOptionSecond.value);
      ...
      axios
        .post("http://localhost:5000/product/save", formData, config)
        .then(response => {
          ...
          <div className={props.class}>
            ...
            >
              <ul className="form" align="center">
                ...
                <li>{this.state.errormessagetitle}</li>
                ...
                <li>{this.state.errormessagedescription}</li>
                  ...
                  <div class="row">
                    <div class="column">
                      <TextField
                        ...
                        onBlur={this.myChangeHandler}
                      />
                      <li>{this.state.errormessageprix}</li>
                    </div>
                    ...
                    <div class="column">
                      <TextField
                        ...
                        onBlur={this.myChangeHandler}
                      />
                      <li>{this.state.errormessagecity}</li>
                    </div>
                  </div>
                </li>
                ...
                <div class="row">
                  ...
                  <div class="column">
                    ...
                    >
                      <input type="file" name="pic2" accept="image/*" onChange={this.handleChangePic}/>2
                    </label>
                  </div>
                  ...
                  <div class="column">
                    ...
                    >
                      <input type="file" name="pic3" accept="image/*" onChange={this.handleChangePic} />3
                    </label>
                  </div>
                  ...
                  <div class="column">
                    ...
                    >
                      <input type="file" name="pic4" accept="image/*" onChange={this.handleChangePic}/>4
                    </label>
                  </div>
                  ...
                  <div class="column">
                    ...
                    >
                      <input type="file" name="pic5" accept="image/*" onChange={this.handleChangePic}/>5
                    </label>
                  </div>
                  ...
                  <div class="column">
                    ...
                    >
                      <input type="file" name="pic6" accept="image/*" onChange={this.handleChangePic}/>6
                    </label>
                  </div>
        ...
        <div className="form-input">
          <div>
            ...
            >
              {matches => (
                <Fragment>
                  {matches.small && <this.Frame class={"div-root-mobile"} />}
                  {matches.medium && <this.Frame class={"div-root-desktop"} />}
                  {matches.large && <this.Frame class={"div-root-desktop"} />}
                </Fragment>
              )}
            </Media>
          </div>
